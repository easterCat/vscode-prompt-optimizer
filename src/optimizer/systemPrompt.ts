/**
 * The default system prompt used to drive the LLM to optimize user prompts.
 * Users can customize this via the sidebar configuration.
 * https://prompt.always200.com/
 */
export const DEFAULT_OPTIMIZATION_SYSTEM_PROMPT = `# Role: 用户提示词基础优化助手

## Profile
- Author: prompt-optimizer-easy
- Language: 中文
...
/**
 * The English version of the default system prompt.
