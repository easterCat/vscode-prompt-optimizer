...
3. 搜索 **Easy Prompt Optimizer**
4. 点击 **安装**

### 配置

1. 点击活动栏中的 **Easy Prompt Optimizer** 图标打开侧边栏
2. 展开 **模型配置** 区域
...
1. 打开 Easy Prompt Optimizer 侧边栏
2. 在 **原始提示词** 文本区域中输入你的提示词
3. 点击 **优化**
4. 在 **优化后的提示词** 区域查看改进结果
5. 点击 **复制** 将结果复制到剪贴板

你也可以在编辑器中选中文本，右键选择 **Send to Easy Prompt Optimizer**，将文本自动填入输入框。
